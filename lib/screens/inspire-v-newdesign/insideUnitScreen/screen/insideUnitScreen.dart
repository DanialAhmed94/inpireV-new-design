...
import '../widget/expandableCard_insideUnit.dart';


class InspireVInsideUnitScreen extends GetView<InspireVInsideUnitScreenController> {
  const InspireVInsideUnitScreen({Key? key}) : super(key: key);
  static const String routes = '/insideUnitScreenAreas1';

  @override
  Widget build(BuildContext context) {
    return GetBuilder<InspireVInsideUnitScreenController>(
      init: InspireVInsideUnitScreenController(),
      assignId: true,
      builder: (controller) {
        return BaseScreen(
                                      ...
                                      child: Column(
                                        ...
                                        children: List.generate(
                                          ...
                                          return Container(
                                            ...
                                            child: InsideUnitScreenExpandableRoomCard(
