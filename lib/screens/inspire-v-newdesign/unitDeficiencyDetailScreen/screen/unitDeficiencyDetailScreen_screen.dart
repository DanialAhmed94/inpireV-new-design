...
class InpireVUnitDeficiencyDetailScreen
    extends GetView<InpireVUnitDeficiencyDetailScontroller> {
  const InpireVUnitDeficiencyDetailScreen({Key? key}) : super(key: key);
  static const String routes = '/InpireVUnitDeficiencyDetail';

  @override
  @override
  Widget build(BuildContext context) {
    return GetBuilder<InpireVUnitDeficiencyDetailScontroller>(
      init: InpireVUnitDeficiencyDetailScontroller(),
      assignId: true,
      builder: (controller) {
        return BaseScreen(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Spacer(),
                              CommonIconButton(
                                icon: deficiencyInfoIcon,
                                iconheigth: 16,
                                textColor: Color(0xFFB45309),
                                title: "Deficiency Info",
                                onTap: () {controller.showDeficiencyCriteriaDialog(context);},
                                color: Color(0xFFFCF5CE),
                              )
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(child: _DeficiencyRadioCard()),
                            ],
                          ),
                            ...
                            children: [
                              Expanded(
                                child: CommonTextField(
                                  ...
                                  onChange: (str) {
                                    controller.visibleBtn = str.isNotEmpty &&
                                        controller
