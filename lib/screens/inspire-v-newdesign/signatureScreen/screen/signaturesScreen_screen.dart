...
class InspireVSignatureScreen extends GetView<InspireVSignatureController> {
  const InspireVSignatureScreen({Key? key}) : super(key: key);
  static const routes = "/InspireVSignatureScreen";

  @override
  Widget build(BuildContext context) {
    return GetBuilder<InspireVSignatureController>(
      builder: (controller) {
        return SafeArea(
          child: BaseScreen(
                        ...
                        Row(
                          ...
                          children: [
                            controller.imageUploadStatus ==
                                ImageUploadStatus1.success ||
                                controller.imageUploadStatus ==
                                    ImageUploadStatus1.initial
                                ? CommonButton(
