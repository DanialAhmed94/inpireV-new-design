...
import '../screens/quic_fail_defeciency_listing/screen/quic_fails_defecieny_listing_screen.dart';
import '../screens/quic_fails_deficiency_detail/quic_fails_deficiency_detail_controller/QF_deficiency_detail_controller.dart';
import '../screens/quic_fails_deficiency_detail/quic_fails_deficiency_detail_screen/quic_fails_deficiency_detail_screen.dart';
import '../screens/quic_fails_inspection_screen/controller/area_listing_controller.dart';
import '../screens/quic_fails_inspection_screen/screen/area_listing_screen.dart';
...
class AppPages {
  static var list = [
    ...
    GetPage(
      name: AreasPage.routes,
      page: () => const AreasPage(),
      binding: BindingsBuilder(() {
        Get.lazyPut<AreasControllerNew>(() => AreasControllerNew());
      }),
    ),
    GetPage(
      name: QuickFailDeficiencyListingScreen.routes,
      page: () => const QuickFailDeficiencyListingScreen(),
      binding: BindingsBuilder(() {
        Get.lazyPut<DeficiencyListingController>(
            () => DeficiencyListingController());
      }),
    ),
    GetPage(
      name: QuickFailDeficiencyDetailScreen.routes,
      page: () => const QuickFailDeficiencyDetailScreen(),
      binding: BindingsBuilder(() {
        Get.lazyPut<QuickFailsDeficiencyDetailController>(
                () => QuickFailsDeficiencyDetailController());
      }),
    ),
    ...
    GetPage(
      ...
      binding: InspireVSigningBinding(),
    ),
    GetPage(
      name: InspireVHomeScreen.routes,
      page: () => const InspireVHomeScreen(),
